...
# ctc-guarantee-balance-test-support

The test support service for the CTC Guarantee Balance API. This service can be used to trigger simulated balance query responses.
...
This application runs on port 10209.

To run with sbt, stop the Service Manager instance of this service using `sm --stop CTC_GUARANTEE_BALANCE_TEST_SUPPORT` before running with `sbt run` from the project folder.
